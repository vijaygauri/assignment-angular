...
demoapp.config(['$routeProvider', function($routeProvider){
    $routeProvider.when('/demoapp',{templateUrl: 'src/demoapp/demoapp.html',
    ...
    templateUrl:'src/demoapp/home.html',
...
demoapp.controller('demoGridController',['$scope','demoService', function($scope,demoService){
     $scope.gridOptions1 = {
